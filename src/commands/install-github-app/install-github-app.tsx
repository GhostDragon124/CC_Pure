...
type ParsedGitHubRepoUrl = { ok: true; repoName: string } | { ok: false };

function parsedGitHubRepoFromParts(owner: string | undefined, repo: string | undefined): ParsedGitHubRepoUrl {
    ...
    if (state.step === 'warnings') {
      ...
      if (!repoName.includes('/')) {
        repoWarnings.push({
          ...
          instructions: ['Use format: owner/repo', `Example: ${OFFICIAL_GITHUB_ORG}/claude-cli`],
        });
      }
