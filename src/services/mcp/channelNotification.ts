...
export const ChannelMessageNotificationSchema = asMCPSchema(
  lazySchema(() =>
    z.object({
...
export const ChannelPermissionNotificationSchema = asMCPSchema(
  lazySchema(() =>
    z.object({
...
export const ChannelPermissionRequestNotificationSchema = asMCPSchema(
  lazySchema(() =>
    z.object({
