...
const WorkflowDetailDialog = feature('WORKFLOW_SCRIPTS') ? WorkflowDetailDialogValue : null;
const killWorkflowTask = feature('WORKFLOW_SCRIPTS') ? killWorkflowTaskValue : null;
const skipWorkflowAgent = feature('WORKFLOW_SCRIPTS') ? skipWorkflowAgentValue : null;
const retryWorkflowAgent = feature('WORKFLOW_SCRIPTS') ? retryWorkflowAgentValue : null;
const killMonitorMcp = feature('MONITOR_TOOL') ? killMonitorMcpValue : null;
const MonitorMcpDetailDialog = feature('MONITOR_TOOL') ? MonitorMcpDetailDialogValue : null;
